...
HD_PWD='C:/Users/Jeremiah/Programming/EE-460M/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4parkingMeterTop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Lab4parkingMeterTop.tcl
