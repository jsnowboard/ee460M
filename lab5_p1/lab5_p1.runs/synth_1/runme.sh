...
HD_PWD='C:/Users/Jeremiah/Programming/ee460M/lab5_p1/lab5_p1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_PartB.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Lab5_PartB.tcl
