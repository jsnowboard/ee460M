...
HD_PWD='C:/Users/Jeremiah/Programming/ee460M/lab5_p1/lab5_p1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_PartB.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Lab5_PartB.tcl -notrace
